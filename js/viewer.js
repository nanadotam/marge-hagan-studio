...
<head>
  ...
  <style>
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
    ...
    .f-big-head{font-size:clamp(38px,6vw,70px);line-height:1.5;color:#F5D7D7;text-transform:uppercase;letter-spacing:-.01em;margin-bottom:20px;font-family:${fontBoldonse ? "'Boldonse'" : '"Montserrat"'},sans-serif;font-weight:${fontBoldonse ? 'normal' : '900'};}
